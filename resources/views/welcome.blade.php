...
<body>
    <div class="super_container">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="newsletter_content text-center">
                            ...
                            <div class="newsletter_text">
                                <p>Tell us a little about yourself below to gain access today:</p>
                            </div>
        ...
        <footer class="footer">
            <div class="footer_background" style="background-image:url(theme/images/footer.jpg)"></div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div
                            ...
                            <div class="copyright ml-auto mr-auto">
                                Copyright &copy;<script>
                                    ...
                                    target="_blank">TriaMatter Interactive</a>
                            </div>
    ...
    <script src="{{ asset('theme/plugins/greensock/TimelineMax.min.js') }}"></script>
    <script src="{{ asset('theme/plugins/scrollmagic/ScrollMagic.min.js') }}"></script>
    <script src="{{ asset('theme/plugins/greensock/animation.gsap.min.js') }}"></script>
    <script src="{{ asset('theme/plugins/greensock/ScrollToPlugin.min.js') }}"></script>
    <script src="{{ asset('theme/plugins/OwlCarousel2-2.2.1/owl.carousel.js') }}"></script>
    <script src="{{ asset('theme/plugins/Isotope/isotope.pkgd.min.js') }}"></script>
